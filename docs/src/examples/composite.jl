...
scatter(getindex.(full_res.embedding, 1), getindex.(full_res.embedding, 2), color=fmnist_y, markersize=4)
...
scatter(getindex.(top_res.embedding, 1), getindex.(top_res.embedding, 2), color=fmnist_y, markersize=4)

# ╔═╡ ac782134-49f4-11eb-10ea-c7e52db8b095
bot_res = UMAP.fit(fmnist_x_bot)

# ╔═╡ b1e2d27e-49f4-11eb-3ede-5bb7c13d38c3
scatter(getindex.(bot_res.embedding, 1), getindex.(bot_res.embedding, 2), color=fmnist_y, markersize=4)
...
scatter(getindex.(comp_res.embedding, 1), getindex.(comp_res.embedding, 2), color=fmnist_y, markersize=4)
